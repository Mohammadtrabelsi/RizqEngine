...
return [
    ...
    'return_control_hint' => 'الرقابة الفعلية إلزامية: أدخل الكمية المستلمة فعلياً. يُسجَّل الفرق كاستهلاك/فقد. لا إعادة إدخال تلقائية.',
    ...
    'entry-created' => 'تم إنشاء إذن الإدخال وإغلاق إذن الصرف',
];
