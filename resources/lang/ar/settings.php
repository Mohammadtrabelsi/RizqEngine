...
return [
    ...
    'tax_settings_hint' => 'اختر كيفية إدخال الضرائب افتراضيًا عند الشراء والبيع. تفتح عروض الأسعار والطلبات والفواتير الجديدة بالوضع المحدد هنا.',
    'purchase_tax_mode' => 'وضع ضريبة الشراء',
    'purchase_tax_mode_hint' => 'الوضع الافتراضي لمستندات الشراء (المشتريات، طلبات الموردين).',
    'sale_tax_mode' => 'وضع ضريبة البيع',
    'sale_tax_mode_hint' => 'الوضع الافتراضي لمستندات البيع (عروض الأسعار، الطلبات، الفواتير).',
    'fiscal_stamp_amount' => 'الطابع الجبائي',
    'invoice_legal_mention' => 'البيانات القانونية للفاتورة',
];
