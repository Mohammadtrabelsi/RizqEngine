                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input id="paid_amount" type="text" class="form-control" name="paid_amount" data-money-mask data-money-allow-zero data-money-prefill required value="{{ $purchase->paid_amount }}" readonly>
                                    </div>
                                </div>
                            </div>
