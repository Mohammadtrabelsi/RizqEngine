                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <button id="getTotalAmount" class="btn btn-primary" type="button" data-money-fill="#paid_amount" data-money-value-from="[name='total_amount']" data-money-value="{{ Cart::instance('purchase')->total() }}">
