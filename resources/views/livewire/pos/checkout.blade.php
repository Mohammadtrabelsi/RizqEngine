        ...
        <div class="card-body">
            <div>
                ...
                <div class="form-group">
                    <label for="customer_id">{{ __('checkout.customer') }} <span class="text-danger">*</span></label>
                    <div class="input-group">
                        ...
                        <select wire:model.live="customer_id" id="customer_id" class="form-control">
                            <option value="" selected>{{ __('checkout.select-customer') }}</option>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr class="text-center">
                            <th class="align-middle">{{ __('checkout.product') }}</th>
                            <th class="align-middle">{{ __('checkout.price') }}</th>
                            <th class="align-middle">{{ __('checkout.quantity') }}</th>
                            <th class="align-middle">{{ __('checkout.action') }}</th>
                        </tr>
                        </thead>
                        <tbody>
                        ...
                        <span class="text-danger">
                            {{ __('checkout.search-select-products') }}
                        </span>
                                </td>
                            </tr>
                        @endif
