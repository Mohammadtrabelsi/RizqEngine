                        ...
                        <div class="form-row">
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <select wire:model="sale_status" class="block w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm leading-normal text-slate-900 placeholder:text-slate-400 transition-colors focus:border-indigo-500 focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 disabled:opacity-45" name="sale_status">
                            ...
                            <tbody>
                                @forelse($sales as $sale)
                                    <tr>
                                        ...
                                        <td><i class="bi bi-person text-muted"></i> {{ $sale->customer_name }}</td>
                                        <td>{{ \Carbon\Carbon::parse($sale->date)->format('d M, Y') }}</td>
                                        <td class="text-end">{{ format_currency($sale->total_amount) }}</td>
                                        <td class="text-end text-success">{{ format_currency($sale->paid_amount) }}</td>
