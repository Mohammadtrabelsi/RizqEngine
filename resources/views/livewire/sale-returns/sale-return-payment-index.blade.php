<div>
    ...
    <div class="row">
                    ...
                    <div class="px-4 py-3 bg-slate-50 border-t border-slate-200 text-center">
                        <div class="btn-group">
                            @can('access_sale_return_payments')
                                <a href="{{ route('sale-return-payments.edit', [$saleReturnId, $payment->id]) }}" class="btn btn-info btn-sm"><i class="bi bi-pencil"></i></a>
        ...
        @empty
            <div class="col-12">
                <div class="card"><div class="flex-auto p-2 text-center text-muted">{{ __('sales.no_payments_found') }}</div></div>
            </div>
        @endforelse
    </div>
