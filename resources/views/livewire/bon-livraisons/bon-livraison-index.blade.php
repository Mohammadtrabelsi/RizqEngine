            ...
            <div class="row align-items-end">
                <div class="col-12 col-lg-6 mb-3">
                    ...
                    <select wire:model.live="status" class="form-select">
                        ...
                        <option value="pending">{{ __('bonlivraison.status_pending') }}</option>
                        <option value="delivered">{{ __('bonlivraison.status_delivered') }}</option>
                        <option value="invoiced">{{ __('bonlivraison.status_invoiced') }}</option>
                    </select>
                </div>
                <div class="col-12 col-lg-6 mb-3">
                    <div class="row">
