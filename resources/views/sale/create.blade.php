                        ...
                        <form id="sale-form" action="{{ route('sales.store') }}" method="POST">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <button id="getTotalAmount" class="btn btn-primary" type="button" data-money-fill="#paid_amount" data-money-value-from="[name='total_amount']" data-money-value="{{ Cart::instance('sale')->total() }}">
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-primary">
                                    {{ __('common.create') }} <i class="bi bi-check"></i>
                                </button>
                            </div>
                        </form>
                    </div>
