                ...
                <div class="card">
                    <div class="flex-auto p-2">
                        ...
                        <form action="{{ route('stock-exits.store') }}" method="POST">
                            ...
                            <div class="mb-4">
                                <h6 class="text-uppercase text-muted small fw-bold border-bottom pb-2 mb-3">{{ __('stockexit.general_information') }}</h6>
                                <div class="form-row">
                                    <div class="col-lg-4">
                                        <div class="mb-4">
                            ...
                            <div class="mb-4">
                                <h6 class="text-uppercase text-muted small fw-bold border-bottom pb-2 mb-3">{{ __('stockexit.exit_type_section') }}</h6>
                                <div class="form-row">
                                    <div class="col-lg-6">
                                        <div class="mb-4">
                            ...
                            <div class="mb-4">
                                <h6 class="text-uppercase text-muted small fw-bold border-bottom pb-2 mb-3">{{ __('stockexit.logistics') }}</h6>
                                <div class="form-row">
                                    <div class="col-lg-6">
                                        <div class="mb-4">
                            ...
                            <div class="mb-4">
                                <h6 class="text-uppercase text-muted small fw-bold border-bottom pb-2 mb-3">{{ __('stockexit.products') }}</h6>
