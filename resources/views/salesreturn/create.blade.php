...
@section('title', __('sales.add_sale_return'))
                        ...
                        <form id="sale-return-form" action="{{ route('sale-returns.store') }}" method="POST">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <button id="getTotalAmount" class="btn btn-primary" type="button" data-money-fill="#paid_amount" data-money-value-from="[name='total_amount']" data-money-value="{{ Cart::instance('sale_return')->total() }}">
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-primary">
                                    {{ __('sales.create_sale_return') }} <i class="bi bi-check"></i>
                                </button>
                            </div>
                        </form>
                    </div>
