...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        <li class="breadcrumb-item active">{{ __('home.title') }}</li>
    </ol>
@endsection
    ...
    <div class="container-fluid">
                ...
                <div class="card border-0">
                    <div class="card-body p-0 d-flex align-items-center shadow-sm">
                        ...
                        <div>
                            ...
                            <div class="text-muted text-uppercase font-weight-bold small">{{ __('home.sales-return') }}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0">
                    <div class="card-body p-0 d-flex align-items-center shadow-sm">
                        ...
                        <div>
                            ...
                            <div class="text-muted text-uppercase font-weight-bold small">{{ __('home.purchases-return') }}</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-lg-7">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-header">
                        {{ __('home.sales-and-purchases-last-7-days') }}
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-5">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-header">
                        {{ __('home.month-overview') }} {{ now()->format('F, Y') }}
                    </div>
