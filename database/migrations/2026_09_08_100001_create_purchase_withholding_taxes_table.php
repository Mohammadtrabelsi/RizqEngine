...
{
    /**
     * Per-purchase snapshot of each applied withholding tax. The name / code /
     * rate / base are copied at invoice time so later edits to the master
     * withholding tax never rewrite historical documents.
     *
    ...
    {
        Schema::create('purchase_withholding_taxes', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('purchase_withholding_taxes');
    }
};
