...
@php
    $groups = [
        'overview' => [
            ...
            ['key' => 'pos',       'label' => __('nav.point_of_sale'), 'route' => 'pos', 'dot' => true],
        ],
        'transactions' => [
            ['key' => 'products',     'label' => __('nav.products'), 'route' => 'products.index'],
            ['key' => 'transactions', 'label' => __('nav.transactions'), 'route' => 'transactions.index'],
            ['key' => 'quotes',       'label' => __('nav.quotes'), 'route' => 'quotes.index'],
            ['key' => 'orders',       'label' => __('nav.orders'), 'route' => 'orders.index', 'badge' => $orderCount],
        ...
        'people' => [
            ...
            ['key' => 'staff',     'label' => __('nav.staff_roles'), 'route' => 'staff.index'],
        ],
        'insight' => [
            ['key' => 'reports',  'label' => __('nav.reports'), 'route' => 'reports.index'],
