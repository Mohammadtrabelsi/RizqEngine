                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-5 ml-md-auto">
                                <ul class="list-group">
                                    <li class="list-group-item d-flex justify-content-between"><strong>Discount ({{ $sale->discount_percentage }}%)</strong><span>{{ format_currency($sale->discount_amount) }}</span></li>
                                    <li class="list-group-item d-flex justify-content-between"><strong>Tax ({{ $sale->tax_percentage }}%)</strong><span>{{ format_currency($sale->tax_amount) }}</span></li>
                                    <li class="list-group-item d-flex justify-content-between"><strong>Shipping</strong><span>{{ format_currency($sale->shipping_amount) }}</span></li>
                                    <li class="list-group-item d-flex justify-content-between"><strong>Grand Total</strong><strong>{{ format_currency($sale->total_amount) }}</strong></li>
                                </ul>
                            </div>
                        </div>
                    </div>
