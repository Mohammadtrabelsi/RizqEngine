                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-xs-4 col-xs-offset-8">
                            <ul class="list-group">
                                <li class="list-group-item"><strong>Discount ({{ $purchase_return->discount_percentage }}%)</strong> <span class="pull-right">{{ format_currency($purchase_return->discount_amount) }}</span></li>
                                <li class="list-group-item"><strong>Tax ({{ $purchase_return->tax_percentage }}%)</strong> <span class="pull-right">{{ format_currency($purchase_return->tax_amount) }}</span></li>
                                <li class="list-group-item"><strong>Shipping</strong> <span class="pull-right">{{ format_currency($purchase_return->shipping_amount) }}</span></li>
                                <li class="list-group-item"><strong>Grand Total</strong> <span class="pull-right"><strong>{{ format_currency($purchase_return->total_amount) }}</strong></span></li>
                            </ul>
                        </div>
                    </div>
